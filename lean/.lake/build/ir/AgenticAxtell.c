...
lean_object* initialize_AgenticAxtell_SemanticRecovery(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_AgenticAxtell_SemanticRecovery(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_AgenticAxtell_Baseline_LinearStability(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
